namespace ModularMonolith.Modules.Articles.Domain.Articles.Events
{
    ...
    public record ArticleCreatedEvent : ArticleDomainEvent
    {
        public ArticleCreatedEvent(Article article, ArticleName name, ArticleCode code, MeasurementUnitCode unit, string? description) : base(article)
        {
            Name = name;
            Code = code;
            Unit = unit;
